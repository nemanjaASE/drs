...
def register_contact_routes(contact_bp):
    ...
    def send_contact_email():
        ...
        try:
            ...
            email_sent, error_message = ContactService.send_email(contact_message)  # ← NOVI UNPACK
            
            if email_sent:
                return api_response.success(messages.CONTACT_SENT, None, 200)
            else:
                return api_response.error(error_message, 500)  # ← PRIKAŽI GREŠKU
